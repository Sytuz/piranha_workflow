...
namespace Piranha.Data.EF.SQLite.Migrations
{
    ...
    [Migration("20250610074619_AddChangeRequestTransition")]
    partial class AddChangeRequestTransition
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Piranha.Data.ChangeRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("Piranha_ChangeRequests", (string)null);
                });

            modelBuilder.Entity("Piranha.Data.ChangeRequestComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<bool>("IsApprovalComment")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Piranha.Data.WorkflowStage", b =>
                {
                    ...
                    b.ToTable("Piranha_WorkflowStages", (string)null);
                });

            modelBuilder.Entity("Piranha.Data.WorkflowStageRelation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Piranha.Data.ChangeRequest", b =>
                {
                    b.HasOne("Piranha.Data.WorkflowStage", "Stage")
                        .WithMany()
            ...
            modelBuilder.Entity("Piranha.Data.WorkflowStageRelation", b =>
                {
                    b.HasOne("Piranha.Data.WorkflowStage", "SourceStage")
                        .WithMany()
                        .HasForeignKey("SourceStageId");

                    b.HasOne("Piranha.Data.WorkflowStage", "TargetStage")
                        .WithMany()
